                ...
                <div className="message-item" id="m16">
                    <div className="message-inner">
                        <div className="message-head clearfix">
                            <div className="avatar pull-left"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT9ATlm4IrNlpf8FhztG3jRTMhTbdqnEUXdIg&usqp=CAU" alt="avatar" /></div>
                            <div className="user-detail">
                                <div className="d-flex justify-content-between name d-flex handle" >
                                    ...
                                    <button className="btn btn-link px-0 py-0" onClick={props.chat.sent ? props.remove : props.resend} >
                                        {props.chat.sent ? <i className="fas fa-trash-alt" ></i> : <i className="fas fa-repeat fa-lg"></i>}
                                    </button>
                                </div>
